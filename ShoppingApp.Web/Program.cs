...
//builder.Services.AddDbContext<IdentityContext>(options=>options.UseSqlite(builder.Configuration.GetConnectionString("SqliteConnection"))); IdentyContext'le alakalý satýrlarý kaldýrdýk.
...
builder.Services.AddIdentity<User, Role>()
    .AddEntityFrameworkStores</*IdentityContext*/ ShopAppContext>()
    .AddDefaultTokenProviders();
//IdentyContext'le alakalý satýrlarý kaldýrdýk.
